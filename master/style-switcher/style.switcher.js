var styleSwitcher = {
    initialized: !1,
    options: {color: "#CCC", gradient: "false", changeLogo: !0},
    initialize: function () {
        var a = this;
        if (!this.initialized) {
            ...
            jQuery.styleSwitcherCachedScript = function (a, b) {
                ...
                less = {env: "development"}, $.styleSwitcherCachedScript("master/less/less.js").done(function () {
                    a.build(), a.events(), null != $.cookie("colorGradient") && (a.options.gradient = $.cookie("colorGradient")), "img/logo.png" != $("#header .logo img").attr("src") && (a.options.changeLogo = !1), null != $.cookie("skin") ? a.setColor($.cookie("skin")) : a.container.find("ul[data-type=colors] li:first a").click(), null != $.cookie("layout") && a.setLayoutStyle($.cookie("layout")), null != $.cookie("backgroundcolor") && a.setBackgroundColor($.cookie("backgroundcolor")), null != $.cookie("pattern") && a.setPattern($.cookie("pattern")), null == $.cookie("initialized") && (a.container.find("h4 a").click(), $.cookie("initialized", !0)), a.initialized = !0, $(window).load(function () {
    ...
    build: function () {
        ...
        var d = [{Hex: "#0088CC", colorName: "Blue"}, {Hex: "#2BAAB1", colorName: "Green"}, {
            Hex: "#4A5B7D",
            colorName: "Navy"
        }, {Hex: "#E36159", colorName: "Red"}, {Hex: "#B8A279", colorName: "Beige"}, {
            Hex: "#c71c77",
            colorName: "Pink"
        ...
        var i = ["gray_jean", "linedpaper", "az_subtle", "blizzard", "denim", "fancy_deboss", "honey_im_subtle", "linen", "pw_maze_white", "skin_side_up", "stitched_wool", "straws", "subtle_grunge", "textured_stripes", "wild_oliva", "worn_dots", "bright_squares", "random_grey_variations"], j = this.container.find("ul[data-type=patterns]");
        $.each(i, function (a, b) {
    ...
    events: function () {
        ...
        a.container.find("h4 a").click(function (b) {
            b.preventDefault(), a.container.hasClass("active") ? a.container.animate({left: "-" + a.container.width() + "px"}, 300).removeClass("active") : a.container.animate({left: "0"}, 300).addClass("active")
    ...
    setLayoutStyle: function (a, b) {
        ...
        var c = this.container.find("div.options-links.layout"), d = this.container.find("div.patterns");
    ...
    setLogo: function (a) {
        return this.options.changeLogo ? void(a || $.cookie("skin") == this.container.find("ul[data-type=colors] li:first a").attr("data-color-hex") && "dark" != $.cookie("backgroundcolor") ? $("#header .logo img").attr("src", "img/logo-default.png") : "dark" == $.cookie("backgroundcolor") ? $("#header .logo img").attr("src", "img/logo-dark.png") : $("#header .logo img").attr("src", "img/logo.png")) : this
    },
    reset: function () {
